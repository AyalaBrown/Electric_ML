...
def fitness_func(ga_instance, solution, solution_idx):
    # real_solution = get_bin.decode_schedule(solution)
    # print(solution)
    total_cost = 5
    # total_amper = np.zeros(len(real_solution[0]))  # Initialize total amperage for each time slot

    # for charge_info in real_solution:
