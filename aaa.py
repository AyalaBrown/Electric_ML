...
query = "exec dbo.GetElectricPointChargeDetails_acc '20230101','20231230';"
# query="select * from dbo.res_temp;"
...
plt.scatter(X, df1['accAvg']/60, color='red', label='Predicted Data')
